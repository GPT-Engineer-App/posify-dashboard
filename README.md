...
**Project**: posify-dashboard 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**:  create a pos with complete cash drawer, supplier , expence , invetory managment refund order modify and purchse , purchase return and dashboard and reports of sale and purchase and pos with barcode scanner but create in pure Php mysqli and bootstrap   
...
```sh
git clone https://github.com/GPT-Engineer-App/posify-dashboard.git
cd posify-dashboard
npm i
